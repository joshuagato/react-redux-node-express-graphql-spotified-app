...
class Experiment extends Component {
    ...
    registerHandler = () => {
        ...
        axios
            .post("http://localhost:8000/api/register", regDetails)
    ...
    render() {
        return (
            <div className="experiments">
                ...
                <button onClick={this.toggleHandler} className="tog-button">
                    Toggle
                </button>
                <button onClick={this.addStudent} className="tog-button">
                    Add Student
                </button>
                <button onClick={this.loginHandler} className="tog-button">
                    Login
                </button>
                <button onClick={this.registerHandler} className="tog-button">
                    Register
                </button>
