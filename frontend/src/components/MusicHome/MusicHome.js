...
class MusicHome extends Component {
    ...
    componentDidMount() {
        if (this.props.location.search === "")
            this.props.history.push("/music-home?browse");
            ...
            <div className="music-home" ref="musicHome">
                ...
                <div className="fixed-bar">
                    <section className="mobile-nav">
                        <NavLink to="/music-home?albums">
                            <FontAwesomeIcon icon={faHome} />
                        </NavLink>
                        <NavLink to="/music-home?search">
                            <FontAwesomeIcon icon={faSearch} />
                        </NavLink>
                        <NavLink to="/music-home?browse">
                            <FontAwesomeIcon icon={faPlay} />
                        </NavLink>
                        <NavLink to="/music-home?playlists">
                            <FontAwesomeIcon icon={faListAlt} />
                        </NavLink>
                        <NavLink to="/music-home?settings">
...
const mapDispatchToProps = (dispatch) => {
    return {
        onFetchUser: (userId) =>
            dispatch(actions.fetchUserForMusicHome(userId)),
    };
};
