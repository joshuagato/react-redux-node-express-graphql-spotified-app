...
export class UpdateDetails extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (
            prevProps.userData.firstname !== this.props.userData.firstname ||
        ...
        return (
            <div className="update-details-container">
                <Form
                    ...
                    btnName="save"
                    submitted={this.detailsChangeHandler}
                >
                    <Input
                        type="text"
                        pholder="First name"
                        changed={this.detailsChangeInputHandler}
                        value={this.state.detailForm.firstname}
                        name="firstname"
                    />
                    ...
                    <Input
                        ...
                        pholder="Last name"
                        changed={this.detailsChangeInputHandler}
                        value={this.state.detailForm.lastname}
                        name="lastname"
                    />
                    ...
                    <Input
                        ...
                        pholder="Email address"
                        changed={this.detailsChangeInputHandler}
                        value={this.state.detailForm.email}
                        name="email"
                    />
                </Form>
                ...
                <Form
                    name="password"
                    pholder="Current Password"
                    btnName="save"
                    submitted={this.passwordUpdateHandler}
                >
                    <Input
                        type="password"
                        pholder="Current Password"
                        changed={this.pwdChangeInputHandler}
                        value={this.state.passwordForm.currentPassword}
                    ...
                    <Input
                        ...
                        changed={(event) => this.pwdChangeInputHandler(event)}
...
const mapDispatchToProps = (dispatch) => {
    return {
        onUpdatePassword: (inputData, token) =>
            dispatch(actions.updatePassword(inputData, token)),
        onUpdateDetails: (inputData, token) =>
            dispatch(actions.updateDetails(inputData, token)),
        onFetchUserDetails: (userId) =>
            dispatch(actions.fetchUserForUpdateDetails(userId)),
    };
};
