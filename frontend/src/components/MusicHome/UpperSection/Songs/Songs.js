...
export class Songs extends Component {
    ...
    render() {
        return (
            <div className="songs-container fade-in">
                {this.props.albumArtwork &&
                this.props.albumTitle &&
                this.props.artistName &&
                this.props.numofsongs ? (
                    <>
                        ...
                        <section className="song-details-section">
                            ...
                            <div className="details-section">
                                ...
                                <p>
                                    {this.props.numofsongs}{" "}
                                    {this.songs(this.props.numofsongs)}
                                </p>
                            </div>
                        </section>
...
const mapDispatchToProps = (dispatch) => {
    return {
        onFetchAllSongDetails: (albumId, artistId) =>
            dispatch(actions.fetchAllSongDetails(albumId, artistId)),
    };
};
