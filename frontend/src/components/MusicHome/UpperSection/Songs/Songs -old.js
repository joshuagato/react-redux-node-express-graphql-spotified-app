...
export class Songs extends Component {
    ...
    UNSAFE_componentWillMount() {
        ...
        axios
            .get("http://localhost:8000/api/songs/" + albumId)
            .then((response) => {
        ...
        axios
            ...
            .then((response) => {
                response.data.map((detail) => {
                    this.setState({
                        artwork: detail.artwork_path,
                        albumTitle: detail.title,
                        artistId: detail.artist,
                    });
                    return detail;
                });
            })
        ...
        axios
            .get("http://localhost:8000/api/numofsongs/" + albumId)
            .then((response) => {
        ...
        axios
            .get("http://localhost:8000/api/artist/" + artistId)
            .then((response) => {
                response.data.map((response) =>
                    this.setState({ artistName: response.name })
                );
            })
            .catch((error) => console.log(error));
    }
                ...
                <section className="song-details-section">
                    ...
                    <div className="details-section">
                        ...
                        <p>
                            ...
                            {this.songs(this.state.numofsongs)}
                        </p>
                    </div>
                </section>
