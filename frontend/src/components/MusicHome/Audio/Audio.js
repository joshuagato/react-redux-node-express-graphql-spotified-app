    ...
    constructor(props) {
        ...
        this.setAudioToPlay = (track) => {
            ...
            this.props.audio.src =
                process.env.REACT_APP_SERVER_MUSIC_URL + track.path;
        };
        ...
        this.playPreviousSong = () => {
            if (this.props.audio.currentTime >= 3 || window.$currentIndex === 0)
                ...
                const trackToPlay = this.props.shuffle
                    ? window.$shufflePlaylist[window.$currentIndex]
                    : window.$currentPlaylist[window.$currentIndex];
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        onSetCurrentlyPlaying: (track) =>
            dispatch(actions.setCurentlyPlaying(track)),
    };
};
