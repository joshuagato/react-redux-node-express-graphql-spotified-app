...
class LowerSection extends Component {
    ...
    componentDidMount() {
        ...
        musicPlayerContainer.addEventListener(
            "mousedown",
            this.preventBehaviour
        );
        musicPlayerContainer.addEventListener(
            "mousemove",
            this.preventBehaviour
    ...
    componentDidUpdate(prevProps, _) {
        ...
        if (prevProps.songs !== this.props.songs) {
            ...
            this.audioInstance.current.setTrack(
                newPlaylist[0],
                newPlaylist,
                false
            );
        ...
        if (
            ...
            this.props.audio.addEventListener("canplay", () => {
                let duration = this.audioInstance.current.formatTime(
        ...
        this.updateTimeProgessBar = (audio) => {
            ...
            const currentTimeValue = this.audioInstance.current.formatTime(
                audio.currentTime
            );
            const timeRemainingValue = this.audioInstance.current.formatTime(
                ...
                <div className="music-player" ref="musicPlayer">
                    ...
                    this.props?.currentlyPlaying?.artistName ? (
                        <div
                            ...
                            onClick={this.openSongsFromLeft}
                        >
                    ...
                    <div className="middle">
                        ...
                        <section className="progress">
                            <span className="current-time" ref="currentTime">
                                0.00
                            </span>
                            <div
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        onSetInitialPlaylistToAllSongs: () =>
            dispatch(actions.setInitialPlaylistToAllSongs()),
