...
class ResetPw extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (
            ...
            prevState.pwdInput.newPassword !==
                this.state.pwdInput.newPassword ||
            prevState.pwdInput.confirmNewPassword !==
                this.state.pwdInput.confirmNewPassword
        ) {
            this.setState({
                email: this.state.email,
                pwdInput: { ...this.state.pwdInput },
            });
        }
    }
    ...
    render() {
        return (
            <div className="reset-pw">
                {this.state.done ? (
                    <EnterPassword
                        submitted={this.resetPassword}
                        changed={this.passwordChangeHandler}
                        value={this.state.pwdInput}
                    />
                ) : (
                    <EnterEmail
                        submitted={this.sendResetToken}
                        message={this.state.message}
                        changed={this.emailInputChangedHandler}
